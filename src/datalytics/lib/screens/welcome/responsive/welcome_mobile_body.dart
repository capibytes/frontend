...
class WelcomeMobileBody extends StatefulWidget {
  const WelcomeMobileBody({super.key});

  @override
  State<WelcomeMobileBody> createState() => _WelcomeMobileBodyState();
}

class _WelcomeMobileBodyState extends State<WelcomeMobileBody> {
